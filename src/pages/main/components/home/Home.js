...
function Home() {
  return (
    <div className='home'>
        ...
        <div class='btnGroup'>
            <button class="BTN ExplorBTN"><i class="ri-folder-line mr-3"></i>Explore My Work</button>
            <button class="BTN ConnectBTN"><i class="ri-chat-3-line mr-3"></i>Let's Connect</button>
        </div>
    </div>
  )
}
